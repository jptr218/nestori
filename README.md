### Nestori is a tool that uses [DNS Cache Poisoning](https://en.wikipedia.org/wiki/DNS_spoofing) to update cached records in a DNS server, redirecting domains to the malicious IP of your choice.
